module.exports.handler = async (event, context) => {
    ...
    [
      ...
      },
      {
        ...
        phone: "212-226-2828",
        allergySafeOptions: ["Gluten-Free", "Vegan"],
        description: "This sweet shop serves bubble tea, milk tea, and desserts with options for gluten-free and vegan customers.",
    },
    {
        id: 23,
        name: "American Girl Cafe",
        address: "75 Rockefeller Plaza, New York, NY 10019",
        phone: "877-247-5223",
        allergySafeOptions: ["Dairy-Free"],
        description: "These cafes are located inside American Girl stores and host lunches and parties by reservation. See our Dairy-Free Tips for American Girl Cafe.",
    },
    {
        id: 24,
        name: "Anita Gelato",
        ...
        phone: "917-675-6451",
        allergySafeOptions: ["Vegan"],
        description: "Though they only have four shops, they’re scattered around the world – one each in Puerto Rico, Israel, Australia, and New York. Anita has a whole vegan lineup of fruity sorbets and creamy soy-based ice creams to choose from.",
    },
    {
        id: 25,
        name: "Anixi",
        address: "193 8th Ave, New York, NY 10011",
        phone: "646-649-2422",
        allergySafeOptions: ["Vegan"],
        notes: "Highly recommended for its diverse vegan menu.",
        description: "Their kosher Mediterranean menu is completely vegan. It includes a large selection of mezze, Turkish flatbreads, kabobs, and a nice gathering of desserts.",
    },
    {
        id: 26,
        name: "AO Bowl",
        ...
        phone: "212-982-2112",
        allergySafeOptions: ["Dairy-Free", "Plant-Based", "Paleo", "Keto"],
        notes: "Known for its innovative and sustainable practices.",
        description: "This East Village organic Japanese eatery and smoothie bar is completely dairy-free, plant-based, and paleo and keto friendly. They focus on organic, locally sourced ingredients and use a revolutionary commercial vacuum blender to prevent nutrient degradation. They also brew their own oatmilk, grow their own microgreens and sprouts, and make nitrogen-infused lattes. In addition to smoothies, they offer an array of breakfast bowls and macrobiotic entrees.",
    },
    {
        id: 27,
        name: "Avant Garden",
        ...
        phone: "646-922-7948",
        allergySafeOptions: ["Vegan"],
        notes: "A great spot for vegan dining and wine enthusiasts.",
        description: "Both their food menu and their curated selection of global natural wines are vegan. Their food menu includes cold dishes, toasts, and a simple menu of plant-forward hot dishes.",
    },
    {
        id: 28,
        name: "Bagels & Co",
        address: "1190 Lexington Ave, New York, NY 10028",
        phone: "212-879-6600",
        allergySafeOptions: ["Dairy-Free Bagels", "Vegan Spreads"],
        description: "Their menus are far from dairy-free, but this kosher shop does offer ample dairy-free bagels daily, a few flavors of tofu 'cream cheese,' and other spreads, like peanut butter and baba ganoush.",
    },
    {
        id: 29,
        ...
        phone: "212-842-0220",
        allergySafeOptions: ["Vegan"],
        description: "This bakery has locations dotted around the city, all selling their indulgent, two-bite cupcakes. They offer several vegan flavors, which include Strawberry, Peanut Butter, Chocolate Vanilla Chip, and Triple Chocolate.",
    }
  ];
